...
function generateCode() {
  ...
  outputCode.value = `background-image: radial-gradient(circle, ${colorAfinal} ${angelone}, ${colorBfinal} ${angeltwo});`;

  document.getElementById(
    "resultcolor"
  ).style.backgroundImage = `radial-gradient(circle, ${colorAfinal} ${angelone}, ${colorBfinal} ${angeltwo})`;
}
